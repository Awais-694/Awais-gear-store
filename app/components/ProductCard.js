...
export default function ProductCard({ product, userRole }) {
  ...
  return (
    <div className="flex flex-col group justify-between h-full bg-white p-2.5 rounded-xl border border-gray-100 hover:shadow-md hover:border-gray-200 transition-all duration-200">
